...
- [x] **npm publish** — `harness-bujang@0.6.1` 라이브 (2026-05-10). https://www.npmjs.com/package/harness-bujang
  ...
  - **0.6.2 publish 대기** — `--help` 한국어 디폴트 + `--help-en` 영어 유지. 부장님 Touch ID 필요.
